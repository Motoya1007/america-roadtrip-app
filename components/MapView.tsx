...
// Inline-styled circle markers — no external assets needed
  ...
  useEffect(() => {
    ...
    import('leaflet').then(({ default: L }) => {
      ...
      for (const d of destinations) {
        ...
        // Popup header line differs for start / goal
        let roleLabel = '';
        if (d.type === 'start') {
        ...
        L.marker([d.latitude, d.longitude], { icon }).addTo(map).bindPopup(popup, {
          maxWidth: 260,
        });
